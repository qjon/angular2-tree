(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@ngrx/store', 'rxjs/Observable', 'rxjs/operators', 'rxjs/add/observable/combineLatest', 'rxjs/add/operator/do', 'lodash.isequal', '@angular/forms', 'ngx-contextmenu', '@ngrx/effects', '@angular/animations', 'rxjs/Subscription', 'rxjs/add/observable/empty', 'rxjs/Subject', 'rxjs/BehaviorSubject', 'rxjs/add/operator/withLatestFrom', 'rxjs/add/observable/merge', '@angular/common/http', 'rxjs/add/observable/of', '@angular/common', 'ng2-dnd', 'ng2-translate'], factory) :
	(factory((global.angular2tree = {}),global.ng.angular.core,global.ng.ngrx.store,global.Observable,global.operators,null,null,global.isEqual,global.ng.angular.forms,global.ngxContextmenu,global.ng.ngrx.effects,global.ng.angular.animations,global.Subscription,null,global.Subject,global.BehaviorSubject,null,null,global.ng.angular['common-http'],null,global.ng.angular.common,global.ng['ng2-dnd'],global.ng['ng2-translate']));
}(this, (function (exports,core,store,Observable,operators,combineLatest,_do,_isEqual,forms,ngxContextmenu,effects,animations,Subscription,empty,Subject,BehaviorSubject,withLatestFrom,merge,http,of,common,ng2Dnd,ng2Translate) { 'use strict';
    ...
    if (treeId) {
        newState[treeId] = {
            nodes: {
                ...
                rootNodes: state[treeId].nodes.rootNodes.slice()
            },
...
function removeNode(state, action) {
    var /** @type {?} */ newState = copyState(state, action.payload.treeId);
...
function expandNode(state, action) {
    var /** @type {?} */ treeId = action.payload.treeId;
    var /** @type {?} */ newState = copyState(state, treeId);
...
function registerTree(state, action) {
    var /** @type {?} */ newState = copyState(state);
...
function treeReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case TreeActionsService.TREE_SET_CONFIGURATION:
            return setConfiguration(state, /** @type {?} */ (action));
...
var /** @type {?} */ treeStateSelector = store.createFeatureSelector('trees');
/**
 * @param {?} treeId
 * @return {?}
 */
...
var TreeModel = /** @class */ (function () {
     ...
     */
    function () {
        return Observable.Observable.combineLatest(this.currentSelectedNode$, this.nodes$)
...
var TreeActionsDispatcherService = /** @class */ (function () {
    function TreeActionsDispatcherService(actions, store$$1) {
 ...
 */
function expand() {
    return animations.trigger('isExpanded', [
        ...
        animations.transition('inactive => active', animations.animate('300ms')),
        animations.transition('active => inactive', animations.animate('300ms'))
    ]);
}
var ItemComponent = /** @class */ (function () {
    function ItemComponent(treeActionsDispatcherService, contextMenuService, actions$) {
        ...
        this.children$ = Observable.Observable.empty();
    ...
    function () {
        ...
        this.subscription.add(this.treeModel.currentSelectedNode$
            .pipe(operators.map(function (node) { return node ? node.id : null; }), operators.distinctUntilChanged())
    ...
    function () {
        ...
        return this.actions$
            ...
            .pipe(operators.filter(function (action) {
...
var DragAndDrop = /** @class */ (function () {
    function DragAndDrop() {
        this.dropStream$ = new Subject.Subject();
        this.dragStream$ = new BehaviorSubject.BehaviorSubject(null);
        this.drop$ = new Observable.Observable();
...
var TreeComponent = /** @class */ (function () {
    function TreeComponent(store$$1, treeActions, dragAndDrop) {
        this.store = store$$1;
...
var DropzoneComponent = /** @class */ (function () {
    function DropzoneComponent(dragAndDrop) {
        ...
        this.isOpen$ = Observable.Observable.merge(isDragStart$, isDragEnd$);
    }
    /**
     * @return {?}
     */
 ...
 * @suppress {checkTypes} checked by tsc
 */
var /** @type {?} */ NODE_SERVICE = new core.InjectionToken('NODE_SERVICE');
var NodeService = /** @class */ (function () {
    ...
    function (nodeId) {
        ...
        var /** @type {?} */ params = new http.HttpParams().set('nodeId', nodeId);
...
var NodeDispatcherService = /** @class */ (function () {
    ...
    NodeDispatcherService.ctorParameters = function () { return [
        { type: Array, decorators: [{ type: core.Inject, args: [NODE_SERVICE,] },] },
    ]; };
...
var TreeEffectsService = /** @class */ (function () {
    function TreeEffectsService(actions$, treeActions, nodeDispatcherService, store$$1) {
        var _this = this;
        this.actions$ = actions$;
        this.treeActions = treeActions;
        ...
        this.load$ = this.actions$
            ...
            .pipe(operators.mergeMap(function (action) {
            return _this.loadNodes(action.payload.treeId, action.payload.id)
                .pipe(operators.map(function (nodesData) { return _this.treeActions.loadTreeSuccess(action.payload.treeId, action.payload.id, nodesData); }), operators.catchError(function () { return Observable.Observable.of(_this.treeActions.loadTreeError(action.payload.treeId, action.payload.id)); }));
        }));
        this.delete$ = this.actions$
            .ofType(TreeActionsService.TREE_DELETE_NODE)
            .pipe(operators.switchMap(function (action) {
            return _this.deleteNode(action.payload.treeId, action.payload.node)
                .pipe(operators.map(function () { return _this.treeActions.deleteNodeSuccess(action.payload.treeId, action.payload.node); }), operators.catchError(function () { return Observable.Observable.of(_this.treeActions.deleteNodeError(action.payload.treeId, action.payload.node)); }));
        }));
        this.save$ = this.actions$
            ...
            return _this.saveNode(action.payload.treeId, __assign$1({}, action.payload.node))
                .pipe(operators.map(function (node) { return _this.treeActions.saveNodeSuccess(action.payload.treeId, action.payload.node, node); }), operators.catchError(function () { return Observable.Observable.of(_this.treeActions.saveNodeError(action.payload.treeId, action.payload.node)); }));
        }));
        this.move$ = this.actions$
            ...
            return _this.moveNode(action.payload.treeId, source, target)
                ...
                return Observable.Observable.of(action.payload);
            }));
        ...
        this.initPathForFullyLoadedTreeEffect$ = this.actions$
            ...
            if (configuration.isFullyLoaded) {
                ...
                return Observable.Observable.combineLatest(loadActions)
    ...
    function (treeId, node) {
        ...
        return node.id ? nodeService.remove(node.id) : Observable.Observable.of(node);
    };
    /**
     * @param {?} treeId
     * @param {?} id
...
var TreeModelGeneratorService = /** @class */ (function () {
    function TreeModelGeneratorService(nodeDispatcherService, treeActionsDispatcher, store$$1) {
        this.nodeDispatcherService = nodeDispatcherService;
...
exports.TreeActionsService = TreeActionsService;
exports.TreeActionsDispatcherService = TreeActionsDispatcherService;
